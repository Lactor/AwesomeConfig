...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "Emacs", "WWW", "Music", 4, 5, 6, 7, 8, 9 }, s, layouts[1])
end
-- }}}
...
function battery_status ()
    ...
    local fd=io.popen("acpi -V", "r") --list present batteries
    local line=fd:read()
...
mybattmon:set_text(" " .. battery_status() .. " ")
...
vicious.register(cpuwidget, vicious.widgets.cpu, "$2%/$3%", 5)
